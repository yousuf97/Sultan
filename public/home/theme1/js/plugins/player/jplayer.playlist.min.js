/*! jPlayerPlaylist for jPlayer 2.9.2 ~ (c) 2009-2014 Happyworm Ltd ~ MIT License */ ! function(a, b) {
    jPlayerPlaylist = function(b, c, d) {
        ...
        _createListItem: function (b) {
            ...
            var web_url = window.location.origin+'/home/theme1/';
             return d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='0'><span class='que_img'><img src='"+b.image+"'></span ><div class='que_data'>" + '<p class="cut_text">'+ b.title +'</p>' + (b.artist ? " <span class='jp-artist'>by " + b.artist + "</span>" : "") + "</div></a>", d += "<div class='action'><span class='que_more _hide'><img src='"+web_url+"images/svg/more.svg'></span><span class='que_close'><img src='"+web_url+"images/svg/close.svg'></span></div></div>"+b.option+"</li>"
        },
